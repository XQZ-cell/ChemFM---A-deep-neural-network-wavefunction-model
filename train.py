...
# Local module imports (ensure project path is in sys.path)
project_root = "/data/home/yinchang/mydeepqmc"
...
def train(cfg):
    ...
    if cfg.mode == 'training':  # Training mode
        ...
        raise NotImplementedError(f"Unknown mode: {cfg_mode}.")
